...
def test_fetch_length_features(q1, q2):
    ...
    length_features[2] = len(substrings[0]) / (min(len(q1), len(q2)) + 1) if substrings else 0
...
def query_point_creator(q1, q2):
    ...
    num_features.extend([
        ...
        test_common_words(q1, q2) / (test_total_words(q1, q2) + 1)
    ])

    num_features.extend(test_fetch_token_features(q1, q2))
    num_features.extend(test_fetch_length_features(q1, q2))
    num_features.extend(test_fetch_fuzzy_features(q1, q2))

    num_features = np.array(num_features).reshape(1, -1)
